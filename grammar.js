...
var grammar = {
    ...
    {"name": "command", "symbols": ["why", "move", "entity"], "postprocess": R({command:"why", entity:2})},
    {"name": "command", "symbols": ["why", "take", "entity"], "postprocess": R({command:"why", entity:2})},
    ...
    {"name": "why$string$1", "symbols": [{"literal":"w"}, {"literal":"h"}, {"literal":"y"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "why$string$2", "symbols": [{"literal":"d"}, {"literal":"i"}, {"literal":"d"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "why$string$3", "symbols": [{"literal":"y"}, {"literal":"o"}, {"literal":"u"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "why", "symbols": ["why$string$1", "why$string$2", "why$string$3"]},
